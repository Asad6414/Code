...
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code/main/data67-99.csv")
...
wti_oil <- ts(data$wti_oil, start= c(1967, 1), freq = 4) # Not necessesary to take log
...
bv.est <- VAR(data.bv, p = 12, type = "const", season = NULL, exog = NULL)
summary(bv.est)
...
#To load the data and store the time series objects
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code/main/data_tr67-99.csv")
# data <- read.csv(file = "data67-99.csv")
...
bv_tr.est <- VAR(data_tr.bv, p = 12, type = "const", season = NULL, exog = NULL)
summary(bv_tr.est)
