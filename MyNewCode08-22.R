...
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code/main/data08-22.csv", show_col_types = FALSE)
...
# gscpi <- ts(log(data$gscpi), start= c(2008, 1), freq = 4) # A NEW VARIABLE DATA
...
#To load the data and store the time series objects
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code/main/data_tr08-22.csv", show_col_types = FALSE)
