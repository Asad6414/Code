...
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code/main/data67-22.csv", show_col_types = FALSE)
...
#To load the data and store the time series objects
data<-read_csv("https://raw.githubusercontent.com/Asad6414/Code/main/data_tr67-22.csv", show_col_types = FALSE)
